...
from core.rvc_engine import RecoveryProtocolRVC
...
def main():
    parser = argparse.ArgumentParser(description="PROJECT: TETO_RECOVERY_PROTOCOL")
    parser.add_argument("texto", help="El texto que Tomori dirá")
